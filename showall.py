...
canvas.create_window((2,2),window=main_frame,anchor="nw")
canvas.yview_scroll(300, "units")
canvas.xview_scroll(300, "units")
...
Label(main_frame,text="Salary",bg="brown",fg="white",font=("Georgia",12)).grid(row=0,column=3)
